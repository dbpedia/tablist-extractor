...
COLLECT_MODE_CHOICES = ['s', 't']

CLASSNAME_HELP = "Provide a classname from settings.json and use its mapper functions"
# Help for output format input
OUTPUT_FORMAT_DEFAULT = '1'
# possible output format values
OUTPUT_FORMAT_CHOICES = [1, 2]
...
PATH_FOLDER_RESOURCE_LIST = "Resources"
